...
def utm_from_latlon(lat, lon, alt=0.0):
    ori_gps = np.array([lat, lon, alt])
    ...
    epsg_code = int(utm_crs_list[0].code) 
    ...
    return ori_utm ,epsg_code 

def latlon_from_utm(easting, northing, height, epsg_number):
